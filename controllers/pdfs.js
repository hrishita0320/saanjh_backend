...
const uploadpdf = async (req, res) => {
    try {
        ...
        const uploadFile = async (data, name) => {
           ...
           const response =  await axios.post('http://localhost:3001/en/getparameters', { text: parsed });
        ...
        console.log("hi");
        const analysis_response = await axios.post('http://localhost:3001/en/analysis',{fileId : fileId, jsonObject:jsonObject,patientId: patientId,name : name } );
